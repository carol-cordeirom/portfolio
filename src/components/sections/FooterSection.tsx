...
export default function FooterSection() {
  return (
    <footer className="bg-bg-primary overflow-clip px-section-px-sm md:px-section-px-md xl:px-section-px-xl py-section-py-sm md:py-section-py-md xl:py-section-px-xl relative">
      ...
      <div className="hidden lg:block absolute top-section-py-md xl:top-section-px-xl right-section-px-md xl:right-section-px-xl font-inter font-medium text-text-primary-low text-right text-keyword-md xl:text-[20px] xl:leading-[1.5] uppercase">
